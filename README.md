...
- 本工具文件主体为index.html，或者点击本页面右上角的网页链接跳转，使用前请先在工具页面右上角的设置按钮中，设置对应的API Key值
  ...
  - 本工具API Key值设置后完全使用javascrip的[localStorage](https://www.w3schools.com/jsref/prop_win_localstorage.asp)函数将数据储存在浏览器本地，包括后续的储存收藏点的功能也都是储存在本地
  - 网页版本的本工具还提供定位当前位置的按钮，如果对这些功能感到不适，请到Releases页面下载之前的版本
